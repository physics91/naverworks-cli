...
cd ../..
```
→ 성공 시 PUBLISHED_PACKAGES에 `@physics91org/linux-x64` 추가
...
npm view @physics91org/linux-x64 version
npm view @physics91org/linux-arm64 version
npm view @physics91org/darwin-x64 version
npm view @physics91org/darwin-arm64 version
npm view @physics91org/win32-x64 version
```
